...
describe Processor do
  ...
  describe '#create_links' do
    ...
    it 'does not append domain when link already includes domain' do
      expect(subject.processed_links).to include("http://www.makersacademy.com/changingourprices")
      expect(subject.processed_links).not_to include("http://www.makersacademy.comhttp://www.makersacademy.com/changingourprices")
    end
